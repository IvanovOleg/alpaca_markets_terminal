                    ...
                    .child(
                        div()
                                    ...
                                    if event.modifiers.control {
                                        ...
                                        if zoom_amount > 0 {
                                            ...
                                            this.chart.bars_per_screen =
                                                (this.chart.bars_per_screen + zoom_amount as usize)
                                                    .min(this.chart.bars.len());
                                        } else {
                                            // Zoom in (show fewer bars)
                                            this.chart.bars_per_screen =
                                                (this.chart.bars_per_screen as i32 + zoom_amount)
                                                    .max(10)
                                                    as usize;
                                        }
                                        ...
                                        let max_offset = this
                                            ...
                                            .bars
                                            .len()
                                            .saturating_sub(this.chart.bars_per_screen)
                                            as f32;
                                        ...
                                        if scroll_amount > 0.0 {
                                            ...
                                            this.chart.chart_scroll_offset =
                                                (this.chart.chart_scroll_offset + scroll_amount)
                                                    .min(max_offset);
                                        } else {
                            ...
                            .children(visible_bars.iter().enumerate().map(|(i, bar)| {
                                ...
                                // High-Low wick (thin line) - always 1px for consistency
                                div()
                                    .absolute()
                                    .left(gpui::relative(
                            ...
                            .children(visible_bars.iter().enumerate().map(|(i, bar)| {
                                ...
                                if is_latest_bar {
                                    body_div = body_div.border_2().border_color(color).shadow_lg();
                                } else {
                            ...
                            // Crosshair overlay
                            .children(
                                if self.chart.show_crosshair && self.chart.mouse_position.is_some()
                                {
                                    ...
                                    let adjusted_chart_height =
                                        chart_height - (border_offset * 2.0);

                                    let y_percent =
                                        (adjusted_mouse_y / adjusted_chart_height) * 100.0;

                                    let price_at_cursor = adjusted_max
                                        - ((y_percent / 100.0) as f64 * adjusted_range);
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .when(
                                end_index == self.chart.bars.len()
                                    && self.chart.market_data_connected,
                                |this| {
                                    this.child(
                                        div()
                                            .px_2()
                        ...
                        div()
                            ...
                            .on_mouse_down(
                                ...
                                cx.listener(|this, _event: &gpui::MouseDownEvent, _window, cx| {
                                    ...
                                    this.chart.chart_scroll_offset = this
                                        .chart
                                        .bars
                                        .len()
                                        .saturating_sub(this.chart.bars_per_screen)
